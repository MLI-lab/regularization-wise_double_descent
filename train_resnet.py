...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.scale_lr:
        ...
        param_setup = [{'params': cur_lay.parameters(), 'lr': args.scale_lr[cur_name]} 
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        tr_acc1, tr_acc5 = validate(train_loader, model, criterion, args)
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        if args.use_inverse_sqrt_lr:
            ...
            for cur_p, param_group in enumerate(optimizer.param_groups):
                ...
                if ((args.lr_reset_epoch and (epoch >= args.lr_reset_epoch)) 
                    or 
                    (args.lr_scale_epoch and (epoch < args.lr_scale_epoch))):
                    base_lr = args.lr
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr-reset-epoch', type=int, default=0,
                        help='Set an epoch to reset the scaling of learning rates.')
    parser.add_argument('--lr-scale-epoch', type=int, default=0,
                        help='Set an epoch to start the scaling of learning rates.')
